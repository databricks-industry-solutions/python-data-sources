...
def convert_to_html_fragment(filepath):
    ...
    for i, cell in enumerate(cells):
        if cell["type"] == "markdown":
            ...
            md_html = markdown.markdown(cell["content"], extensions=["fenced_code", "tables", "nl2br", "toc"])
            html_content.append(
                f"""<div class="cell border-box-sizing text_cell rendered">
...
{md_html}
            ...
            html_content.append(
                f"""<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="inner_cell">
