...
class MqttDataSource(DataSource):
    ...
    def streamReader(self, schema: StructType) -> "MqttSimpleStreamReader":
        """
...
class MqttSimpleStreamReader(SimpleDataSourceStreamReader):
    ...
    def _validate_broker_address(self) -> None:
        """
    ...
    @staticmethod
    def _is_valid_hostname(hostname) -> bool:
        """
    ...
    @staticmethod
    def _parse_topic(topic_str: str) -> str:
        """
    ...
    @staticmethod
    def partitions(self, start: dict[str, int], end: dict[str, int]) -> list[RangePartition]:
        """
    ...
    def _get_mqtt_client(self) -> mqttclient.Client:
